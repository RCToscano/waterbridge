...
<html>
    <head>
	    ...
	    <script src="./js/consumoMedidor/medidor.js" type="text/javascript"></script>
        ...
        <div class="container">
			...
			<div class="form-group">
				<form data-toggle="validator" role="form" id="formUsuarioMedidor" action="#" method="POST" accept-charset="iso-8859-1,utf-8">
					<fieldset>
						<legend class="text-left">Exclusão de Consumo por Medidor</legend>
						
						<div class="col-sm-3">
							<div class="form-group">
								<label class="control-label">Device:</label><label class="text-danger">*</label>
								<input type="text" class="form-control" id="device" name="device" value="${device}" maxlength="20" required/>
							</div>
						</div>
						
						<div class="col-sm-2">
							<div class="form-group">
								<label class="control-label">Data</label><label class="text-danger">*</label>
