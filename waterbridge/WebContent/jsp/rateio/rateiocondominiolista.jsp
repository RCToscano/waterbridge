    ...
    <body>
        ...
        <div class="container">
        	<ul class="breadcrumb">
			    ...
			    <li class="active">Executar Rateio</li>
			</ul>
			...
			<div class="form-group">
				...
				<form data-toggle="validator" role="form" id="formUsuarioMedidor" action="#" method="POST" accept-charset="iso-8859-1,utf-8" >
					<fieldset>
						<legend class="text-left">Executar Rateio</legend>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="form-group">	
								...
								<select class="form-control input-sm" id="idCondominio" name="idCondominio" required onchange="listarConta()">
									<option value="" selected>Selecione...</option>
								</select>					
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">	
								<label class="control-label">Conta</label><label class="text-danger">*</label>
								<select class="form-control input-sm" id="idConta" name="idConta" required>
									<option value="" selected>Selecione...</option>
								</select>					
							</div>
						</div>
