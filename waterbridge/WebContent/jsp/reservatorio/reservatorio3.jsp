...
<body>
	<div class="container-fluid">
		<div class="row" style="text-align: center; padding-top: 5px; background-color: #156fc3;">			
			<div class="col-sm-2 text-center"></div>
			<div class="col-sm-2 text-center"></div>
            <div class="col-sm-4 text-center"><p class="text-muted"><label style="font-size: 16pt; color: white;">Reservatórios</label></p></div>
		...
		<div class="row" id="divReservatorio"></div>
	</div>
	
	<c:set var = "cont" value = "1"/>
	<c:forEach var="relPressaoLast" items="${listRelPressaoLast}">
		<script type="text/javascript">
			
			$("#divReservatorio").append(
			'<div class="col-sm-1" style="padding: 3px;">' +		    
			'	<div id="container${cont}"></div>' +
			'</div>'			
			);
