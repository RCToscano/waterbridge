...
//				}
		...
		else if (req.getParameter("acao") != null && req.getParameter("acao").equals("2")) {//ATUALIZA VALORES DO MAPA
...
//				}
				...
				res.getWriter().write(new Gson().toJson(listRelMapaConsumoPressao));   
			}
	        catch (Exception e) {
	            req.setAttribute("erro", e.toString());
	            req.getRequestDispatcher("/jsp/erro.jsp").forward(req, res);
