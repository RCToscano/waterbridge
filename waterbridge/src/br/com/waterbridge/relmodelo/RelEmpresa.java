...
public class RelEmpresa {
	...
	private String obs;
	List<RelUserEmpresa> listRelUserEmpresa;
	...
	public List<RelUserEmpresa> getListRelUserEmpresa() {
		return listRelUserEmpresa;
	}
	public void setListRelUserEmpresa(List<RelUserEmpresa> listRelUserEmpresa) {
		this.listRelUserEmpresa = listRelUserEmpresa;
	}
