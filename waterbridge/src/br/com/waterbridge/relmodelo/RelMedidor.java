...
public class RelMedidor {
	...
	private Long idBridgeTpAlim;
	private String bridgeTpAlim;
	private Long idBridgeTp;
	private String bridgeTp;
	...
	public Long getIdBridgeTpAlim() {
		return idBridgeTpAlim;
	}
	public void setIdBridgeTpAlim(Long idBridgeTpAlim) {
		this.idBridgeTpAlim = idBridgeTpAlim;
	}
	public String getBridgeTpAlim() {
		return bridgeTpAlim;
	}
	public void setBridgeTpAlim(String bridgeTpAlim) {
	...
	public String getBridgeTp() {
		return bridgeTp;
	}
	public void setBridgeTp(String bridgeTp) {
	...
	public Long getValidBateria() {
		return validBateria;
	}
	public void setValidBateria(Long validBateria) {
